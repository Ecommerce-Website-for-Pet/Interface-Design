  ...
  if (name == "Dog-Product.html") {
    for (i = 0; i < arr.length; i++) {
      div +=
        ...
        arr[i].image +
        ' "alt=""><button type = "button" class = "add-to-cart-btn">Thêm vào giỏ</button><button type = "button" class = "view-product-detail-btn">Xem chi tiết</button></div><div class="product-info"><div class="product-label"> ' +
        arr[i].label +
